const en = {
  ...
  comingSoonDescription: "This feature is on the way — check back soon.",
  retry: "Retry",

  // Dashboard taglines, per business type (see config/businessType.ts)
  dashboardTaglineMedical: "Here's what's happening at your clinic today.",
  dashboardTaglineRealEstate:
    "Here's what's happening with your properties today.",
  dashboardTaglineAutoParts: "Here's what's happening with your shop today.",

  // Entity labels, per business type
  patients: "Patients",
  patient: "Patient",
  clients: "Clients",
  client: "Client",
  ...
  // Contacts page
  searchContactsPlaceholder: "Search by name, email, or organization...",
  noContactsFoundTitle: "No {{label}} yet",
  noContactsFoundDescription: "Add your first {{label}} to get started.",
  addContact: "Add {{label}}",
  editContact: "Edit {{label}}",
  deleteContactConfirm: "Delete this {{label}}? This cannot be undone.",
  ...
  taskMarkIncomplete: "Mark incomplete",
  searchTasksPlaceholder: "Search by task title...",
  allPriorities: "All Priorities",
  noTasksFoundTitle: "No tasks yet",
  noTasksFoundDescription: "Add your first task to get started.",
  ...
  activityDescriptionLabel: "Description (optional)",
  activityDateLabel: "Date & Time",
  noActivitiesYetTitle: "No activity logged yet",
  noActivitiesYetDescription: "Log a call, meeting, or note to get started.",
