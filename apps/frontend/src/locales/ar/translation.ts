const ar = {
  ...
  taskContact: "جهة الاتصال",
  taskLead: "العميل المحتمل",
  taskDeal: "الصفقة",
  taskNoneOption: "بدون",
  taskCreatedAt: "تاريخ الإنشاء",
  taskCompletedAt: "تاريخ الإكمال",
  taskMarkComplete: "وضع علامة مكتملة",
  taskMarkIncomplete: "إلغاء علامة الإكمال",
  searchTasksPlaceholder: "ابحث بعنوان المهمة...",
  allPriorities: "كل الأولويات",
  noTasksFoundTitle: "لا توجد مهام بعد",
  noTasksFoundDescription: "أضف أول مهمة للبدء.",
  deleteTaskConfirm: "حذف هذه المهمة؟ لا يمكن التراجع عن ذلك.",
