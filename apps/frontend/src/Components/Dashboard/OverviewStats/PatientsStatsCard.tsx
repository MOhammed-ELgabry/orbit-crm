  ...
  return (
    <div className="group rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="flex items-start justify-between">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-50 text-purple-600 transition-transform duration-200 group-hover:scale-105">
          <FiUsers size={18} />
        </div>
      ...
      {/* Content */}
      <div className="mt-3">
        <p className="text-[12px] font-medium text-slate-500">New Patients</p>
